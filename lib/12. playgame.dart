...
class _playgameState extends State<playgame> {
  ...
  List que = [
    ...
    questions(
        ...
        "https://andimanwno.files.wordpress.com/2020/05/interaksi-interdependensi-angin-darat-dan-angin-laut-pada-siang-hari.jpg?w=500&h=295",
        true),
    questions(
        ...
        true),
    questions(
        "Persebaran flora fauna di Indonesia tidak merata. Hal tersebut dikarenakan kondisi geografis antar wilayah yang berbeda. Prinsip geografi yang dapat digunakan untuk mengkaji fenomena tersebut adalah Persebaran",
        ...
        true),
    questions(
        "Kawasan karst adalah daerah yang terdiri atas batuan kapur yang berpori sehingga air di permukaan tanah selalu merembes dan mengalir ke dalam tanah. ",
        "https://4.bp.blogspot.com/-8F5m9PVDUpk/V70niSp7vjI/AAAAAAAAAgs/IJM69r-WcPsIAfnnsjF_uA6h5Qfg2qCpwCLcB/s640/KARST.jpg",
        true),
    questions(
        "Daerah Gunung Kidul memiliki jenis tanah mediteran. Tanah mediteran merupakan jenis tanah kapur yang terjadi dari hasil proses pelapukan batuan kapur keras dan batuan sedimen. ",
        "https://asset.kompas.com/crops/jwk3Xz8_bFIov0DheRyUixzh9X4=/2x0:3002x2000/750x500/data/photo/2019/12/06/5de990d7894f3.jpg",
        true),
    questions(
        "Pada musim kemarau, tanah gambut akan mudah terbakar. Oleh karena itu, pemerintah harus lebih waspada pada saat musim kemarau di wilayah Hutan di Riau. Fenomena ini dapat dikaji dengan pendekatan keruangan",
